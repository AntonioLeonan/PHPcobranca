...
include('extenso.php');
 ...
 $avalistaNome = buscaCliente::chamaCliente($_POST['avalista']);
      ...
      <div class="row">
          <div class="col-md-12">
              ...
              <div style="text-align:justify;">
                ...
                <p><b>AVALISTA:</b> <?=$avalistaNome['nome']?>, portador (a) da c&eacute;dula de identidade R.G n&deg; <? echo $avalistaNome['identidade']; ?> e CPF n&deg; <? echo $avalistaNome['cpf']; ?> residente
                  e domiciliado(a) na <? echo $avalistaNome['rua']; ?> <? echo $avalistaNome['complemento']; ?>, BAIRRO <? echo $avalistaNome['bairro']; ?> CEP <? echo $avalistaNome['cep']; ?> <? echo $avalistaNome['cidade']; ?> - <? echo $avalistaNome['estado']; ?> </p>
                ...
                <p>
                  ...
                  direito, o DEVEDOR e AVALISTA confessam dever ao CREDOR a quantia l&iacute;quida, certa e exig&iacute;vel no valor de R$ <?=$_POST['valorDivida']?> ( <?=extenso($_POST['valorDivida'])?> ) referente ao (s) contrato (s) sob n&deg; <?=$_POST['contratos']?>. </p>
                <p>
                ...
                <p><b>CL&Aacute;USULA TERCEIRA:</b> &Agrave; D&Iacute;VIDA ora reconhecida e assumida pelo DEVEDOR e AVALISTA, como l&iacute;quida, certa e exig&iacute;vel, no valor acima
